...
// Sources: 15 files
// Generated: 2026-02-08T11:14:02.831307
...
import 'package:tom_vscode_scripting_api/src/vscode_bridge_client.dart' as ext_tom_vscode_scripting_api_vscode_bridge_client;
import 'package:tom_vscode_scripting_api/src/vscode_workspace.dart' as ext_tom_vscode_scripting_api_vscode_workspace;
import 'package:tom_vscode_scripting_api/src/vscode_window.dart' as ext_tom_vscode_scripting_api_vscode_window;
import 'package:tom_vscode_scripting_api/src/vscode_commands.dart' as ext_tom_vscode_scripting_api_vscode_commands;
import 'package:tom_vscode_scripting_api/src/vscode_extensions.dart' as ext_tom_vscode_scripting_api_vscode_extensions;
import 'package:tom_vscode_scripting_api/src/vscode_lm.dart' as ext_tom_vscode_scripting_api_vscode_lm;
import 'package:tom_vscode_scripting_api/src/vscode_chat.dart' as ext_tom_vscode_scripting_api_vscode_chat;
import 'package:tom_vscode_scripting_api/src/vscode_adapter.dart' as ext_tom_vscode_scripting_api_vscode_adapter;
import 'package:tom_vscode_scripting_api/src/vscode.dart' as ext_tom_vscode_scripting_api_vscode;
import 'package:tom_vscode_scripting_api/src/vscode_types.dart' as ext_tom_vscode_scripting_api_vscode_types;
import 'package:tom_vscode_scripting_api/src/vscode_helper.dart' as ext_tom_vscode_scripting_api_vscode_helper;
...
class AllBridge {
  ...
  static List<BridgedEnumDefinition> bridgedEnums() {
    return [
      BridgedEnumDefinition<ext_tom_vscode_scripting_api_vscode_types.DiagnosticSeverity>(
        name: 'DiagnosticSeverity',
        values: ext_tom_vscode_scripting_api_vscode_types.DiagnosticSeverity.values,
      ),
    ];
  }
  ...
  static void registerGlobalVariables(D4rt interpreter, String importPath) {
    ...
    try {
      interpreter.registerGlobalVariable('defaultVSCodeBridgePort', ext_tom_vscode_scripting_api_vscode_bridge_client.defaultVSCodeBridgePort, importPath, sourceUri: 'package:tom_vscode_scripting_api/src/vscode_bridge_client.dart');
    } catch (e) {
...
BridgedClass _createVSCodeAdapterBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_adapter.VSCodeAdapter,
    name: 'VSCodeAdapter',
    constructors: {
    },
    methods: {
      'sendRequest': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_adapter.VSCodeAdapter>(target, 'VSCodeAdapter');
        D4.requireMinArgs(positional, 2, 'sendRequest');
        final method = D4.getRequiredArg<String>(positional, 0, 'method', 'sendRequest');
        if (positional.length <= 1) {
          throw ArgumentError('sendRequest: Missing required argument "params" at position 1');
...
BridgedClass _createVSCodeBridgeResultBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeResult,
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeResult(success: success, value: value, output: output, error: error, stackTrace: stackTrace, exception: exception, exceptionStackTrace: exceptionStackTrace, duration: duration);
      },
      'success': (visitor, positional, named) {
        ...
        final exceptionStackTrace = D4.getOptionalNamedArg<String?>(named, 'exceptionStackTrace');
        final duration = D4.getRequiredNamedArg<Duration>(named, 'duration', 'VSCodeBridgeResult');
        return ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeResult.success(value: value, output: output, exception: exception, exceptionStackTrace: exceptionStackTrace, duration: duration);
      },
      'failure': (visitor, positional, named) {
        ...
        final output = D4.getNamedArgWithDefault<String>(named, 'output', '');
        final duration = D4.getRequiredNamedArg<Duration>(named, 'duration', 'VSCodeBridgeResult');
        return ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeResult.failure(error: error, stackTrace: stackTrace, output: output, duration: duration);
      },
    },
    getters: {
      'success': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeResult>(target, 'VSCodeBridgeResult').success,
      'value': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeResult>(target, 'VSCodeBridgeResult').value,
      'output': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeResult>(target, 'VSCodeBridgeResult').output,
      'error': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeResult>(target, 'VSCodeBridgeResult').error,
      'stackTrace': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeResult>(target, 'VSCodeBridgeResult').stackTrace,
      'exception': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeResult>(target, 'VSCodeBridgeResult').exception,
      'exceptionStackTrace': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeResult>(target, 'VSCodeBridgeResult').exceptionStackTrace,
      'duration': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeResult>(target, 'VSCodeBridgeResult').duration,
      'hasException': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeResult>(target, 'VSCodeBridgeResult').hasException,
    },
    constructorSignatures: {
...
BridgedClass _createVSCodeBridgeClientBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeClient,
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        if (!named.containsKey('port')) {
          return ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeClient(host: host, connectTimeout: connectTimeout, requestTimeout: requestTimeout);
        }
        if (named.containsKey('port')) {
          final port = D4.getRequiredNamedArg<int>(named, 'port', 'VSCodeBridgeClient');
          return ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeClient(host: host, connectTimeout: connectTimeout, requestTimeout: requestTimeout, port: port);
        }
        throw StateError('Unreachable: all named parameter combinations should be covered');
      },
    },
    getters: {
      'host': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeClient>(target, 'VSCodeBridgeClient').host,
      'port': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeClient>(target, 'VSCodeBridgeClient').port,
      'connectTimeout': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeClient>(target, 'VSCodeBridgeClient').connectTimeout,
      'requestTimeout': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeClient>(target, 'VSCodeBridgeClient').requestTimeout,
      'isConnected': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeClient>(target, 'VSCodeBridgeClient').isConnected,
    },
    methods: {
      'connect': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeClient>(target, 'VSCodeBridgeClient');
        return t.connect();
      },
    ...
    staticMethods: {
      'isAvailable': (visitor, positional, named, typeArgs) {
        final host = D4.getNamedArgWithDefault<String>(named, 'host', '127.0.0.1');
        if (!named.containsKey('port')) {
          return ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeClient.isAvailable(host: host);
        }
        if (named.containsKey('port')) {
          final port = D4.getRequiredNamedArg<int>(named, 'port', 'isAvailable');
          return ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeClient.isAvailable(host: host, port: port);
        }
        throw StateError('Unreachable: all named parameter combinations should be covered');
      },
    },
  ...
  return BridgedClass(
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final client = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_bridge_client.VSCodeBridgeClient>(positional, 0, 'client', 'VSCodeBridgeAdapter');
...
BridgedClass _createVSCodeBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode.VSCode,
    name: 'VSCode',
    constructors: {
    },
    getters: {
      'workspace': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode.VSCode>(target, 'VSCode').workspace,
      'window': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode.VSCode>(target, 'VSCode').window,
      'commands': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode.VSCode>(target, 'VSCode').commands,
      'extensions': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode.VSCode>(target, 'VSCode').extensions,
      'lm': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode.VSCode>(target, 'VSCode').lm,
      'chat': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode.VSCode>(target, 'VSCode').chat,
      'adapter': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode.VSCode>(target, 'VSCode').adapter,
    },
    methods: {
      'getVersion': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode.VSCode>(target, 'VSCode');
    ...
    staticGetters: {
      'instance': (visitor) => ext_tom_vscode_scripting_api_vscode.VSCode.instance,
      'isInitialized': (visitor) => ext_tom_vscode_scripting_api_vscode.VSCode.isInitialized,
    },
    staticMethods: {
      'initialize': (visitor, positional, named, typeArgs) {
        D4.requireMinArgs(positional, 1, 'initialize');
        final adapter = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_adapter.VSCodeAdapter>(positional, 0, 'adapter', 'initialize');
        return ext_tom_vscode_scripting_api_vscode.VSCode.initialize(adapter);
      },
    },
    methodSignatures: {
...
BridgedClass _createVSCodeCommandsBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommands,
    name: 'VSCodeCommands',
    constructors: {
      '': (visitor, positional, named) {
        D4.requireMinArgs(positional, 1, 'VSCodeCommands');
        final adapter = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_adapter.VSCodeAdapter>(positional, 0, '_adapter', 'VSCodeCommands');
        return ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommands(adapter);
      },
    },
    methods: {
      'executeCommand': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommands>(target, 'VSCodeCommands');
...
BridgedClass _createVSCodeCommonCommandsBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands,
    name: 'VSCodeCommonCommands',
    constructors: {
    },
    staticGetters: {
      'openFile': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.openFile,
      'openFolder': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.openFolder,
      'newUntitledFile': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.newUntitledFile,
      'saveFile': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.saveFile,
      'saveAllFiles': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.saveAllFiles,
      'closeActiveEditor': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.closeActiveEditor,
      'showCommands': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.showCommands,
      'quickOpen': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.quickOpen,
      'goToFile': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.goToFile,
      'goToSymbol': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.goToSymbol,
      'goToLine': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.goToLine,
      'findInFiles': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.findInFiles,
      'replaceInFiles': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.replaceInFiles,
      'toggleTerminal': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.toggleTerminal,
      'newTerminal': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.newTerminal,
      'toggleSidebar': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.toggleSidebar,
      'togglePanel': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.togglePanel,
      'formatDocument': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.formatDocument,
      'organizeImports': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.organizeImports,
      'renameSymbol': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.renameSymbol,
      'goToDefinition': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.goToDefinition,
      'goToReferences': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.goToReferences,
      'showHover': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.showHover,
      'commentLine': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.commentLine,
      'copyLineDown': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.copyLineDown,
      'moveLineDown': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.moveLineDown,
      'deleteLine': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.deleteLine,
      'reloadWindow': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.reloadWindow,
      'showExtensions': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.showExtensions,
      'installExtension': (visitor) => ext_tom_vscode_scripting_api_vscode_commands.VSCodeCommonCommands.installExtension,
    },
    staticGetterSignatures: {
...
BridgedClass _createExtensionBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_extensions.Extension,
    name: 'Extension',
    constructors: {
      '': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_extensions.Extension(id: id, extensionUri: extensionUri, extensionPath: extensionPath, isActive: isActive, packageJSON: packageJSON, extensionKind: extensionKind);
      },
      'fromJson': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_extensions.Extension.fromJson(json);
      },
    },
    getters: {
      'id': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_extensions.Extension>(target, 'Extension').id,
      'extensionUri': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_extensions.Extension>(target, 'Extension').extensionUri,
      'extensionPath': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_extensions.Extension>(target, 'Extension').extensionPath,
      'isActive': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_extensions.Extension>(target, 'Extension').isActive,
      'packageJSON': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_extensions.Extension>(target, 'Extension').packageJSON,
      'extensionKind': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_extensions.Extension>(target, 'Extension').extensionKind,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_extensions.Extension>(target, 'Extension');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createVSCodeExtensionsBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_extensions.VSCodeExtensions,
    name: 'VSCodeExtensions',
    constructors: {
      '': (visitor, positional, named) {
        D4.requireMinArgs(positional, 1, 'VSCodeExtensions');
        final adapter = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_adapter.VSCodeAdapter>(positional, 0, '_adapter', 'VSCodeExtensions');
        return ext_tom_vscode_scripting_api_vscode_extensions.VSCodeExtensions(adapter);
      },
    },
    methods: {
      'getAll': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_extensions.VSCodeExtensions>(target, 'VSCodeExtensions');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 60);
...
BridgedClass _createVSCodeLanguageModelBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_lm.VSCodeLanguageModel,
    name: 'VSCodeLanguageModel',
    constructors: {
      '': (visitor, positional, named) {
        D4.requireMinArgs(positional, 1, 'VSCodeLanguageModel');
        final adapter = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_adapter.VSCodeAdapter>(positional, 0, '_adapter', 'VSCodeLanguageModel');
        return ext_tom_vscode_scripting_api_vscode_lm.VSCodeLanguageModel(adapter);
      },
    },
    methods: {
      'selectChatModels': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.VSCodeLanguageModel>(target, 'VSCodeLanguageModel');
...
BridgedClass _createLanguageModelChatBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChat,
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChat(id: id, vendor: vendor, family: family, version: version, name: name, maxInputTokens: maxInputTokens);
      },
      'fromJson': (visitor, positional, named) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChat.fromJson(json);
      },
    },
    getters: {
      'id': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChat>(target, 'LanguageModelChat').id,
      'vendor': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChat>(target, 'LanguageModelChat').vendor,
      'family': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChat>(target, 'LanguageModelChat').family,
      'version': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChat>(target, 'LanguageModelChat').version,
      'name': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChat>(target, 'LanguageModelChat').name,
      'maxInputTokens': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChat>(target, 'LanguageModelChat').maxInputTokens,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChat>(target, 'LanguageModelChat');
        return t.toJson();
      },
      'sendRequest': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChat>(target, 'LanguageModelChat');
        D4.requireMinArgs(positional, 2, 'sendRequest');
        final adapter = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_adapter.VSCodeAdapter>(positional, 0, 'adapter', 'sendRequest');
        if (positional.length <= 1) {
          throw ArgumentError('sendRequest: Missing required argument "messages" at position 1');
        }
        final messages = D4.coerceList<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatMessage>(positional[1], 'messages');
      ...
      'countTokens': (visitor, target, positional, named, typeArgs) {
        ...
        final adapter = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_adapter.VSCodeAdapter>(positional, 0, 'adapter', 'countTokens');
...
BridgedClass _createLanguageModelChatMessageBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatMessage,
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatMessage(role: role, content: content, name: name);
      },
      'user': (visitor, positional, named) {
        ...
        final name = D4.getOptionalNamedArg<String?>(named, 'name');
        return ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatMessage.user(content, name: name);
      },
      'assistant': (visitor, positional, named) {
        D4.requireMinArgs(positional, 1, 'LanguageModelChatMessage');
        final content = D4.getRequiredArg<String>(positional, 0, 'content', 'LanguageModelChatMessage');
        final name = D4.getOptionalNamedArg<String?>(named, 'name');
        return ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatMessage.assistant(content, name: name);
      },
      'fromJson': (visitor, positional, named) {
        D4.requireMinArgs(positional, 1, 'LanguageModelChatMessage');
        if (positional.isEmpty) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatMessage.fromJson(json);
      },
    },
    getters: {
      'role': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatMessage>(target, 'LanguageModelChatMessage').role,
      'content': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatMessage>(target, 'LanguageModelChatMessage').content,
      'name': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatMessage>(target, 'LanguageModelChatMessage').name,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatMessage>(target, 'LanguageModelChatMessage');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createLanguageModelChatResponseBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatResponse,
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatResponse(text: text, streamParts: streamParts);
      },
      'fromJson': (visitor, positional, named) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatResponse.fromJson(json);
      },
    },
    getters: {
      'text': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatResponse>(target, 'LanguageModelChatResponse').text,
      'streamParts': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatResponse>(target, 'LanguageModelChatResponse').streamParts,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelChatResponse>(target, 'LanguageModelChatResponse');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createLanguageModelToolResultBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_lm.LanguageModelToolResult,
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_lm.LanguageModelToolResult(content: content);
      },
      'fromJson': (visitor, positional, named) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_lm.LanguageModelToolResult.fromJson(json);
      },
    },
    getters: {
      'content': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelToolResult>(target, 'LanguageModelToolResult').content,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelToolResult>(target, 'LanguageModelToolResult');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createLanguageModelToolInformationBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_lm.LanguageModelToolInformation,
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_lm.LanguageModelToolInformation(name: name, description: description, inputSchema: inputSchema);
      },
      'fromJson': (visitor, positional, named) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_lm.LanguageModelToolInformation.fromJson(json);
      },
    },
    getters: {
      'name': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelToolInformation>(target, 'LanguageModelToolInformation').name,
      'description': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelToolInformation>(target, 'LanguageModelToolInformation').description,
      'inputSchema': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelToolInformation>(target, 'LanguageModelToolInformation').inputSchema,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_lm.LanguageModelToolInformation>(target, 'LanguageModelToolInformation');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createVSCodeWindowBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_window.VSCodeWindow,
    name: 'VSCodeWindow',
    constructors: {
      '': (visitor, positional, named) {
        D4.requireMinArgs(positional, 1, 'VSCodeWindow');
        final adapter = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_adapter.VSCodeAdapter>(positional, 0, '_adapter', 'VSCodeWindow');
        return ext_tom_vscode_scripting_api_vscode_window.VSCodeWindow(adapter);
      },
    },
    methods: {
      'showInformationMessage': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_window.VSCodeWindow>(target, 'VSCodeWindow');
        ...
        final options = D4.getOptionalNamedArg<ext_tom_vscode_scripting_api_vscode_types.MessageOptions?>(named, 'options');
...
BridgedClass _createVSCodeWorkspaceBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_workspace.VSCodeWorkspace,
    name: 'VSCodeWorkspace',
    constructors: {
      '': (visitor, positional, named) {
        D4.requireMinArgs(positional, 1, 'VSCodeWorkspace');
        final adapter = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_adapter.VSCodeAdapter>(positional, 0, '_adapter', 'VSCodeWorkspace');
        return ext_tom_vscode_scripting_api_vscode_workspace.VSCodeWorkspace(adapter);
      },
    },
    methods: {
      'getWorkspaceFolders': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_workspace.VSCodeWorkspace>(target, 'VSCodeWorkspace');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 30);
      ...
      'getWorkspaceFolder': (visitor, target, positional, named, typeArgs) {
        ...
        final uri = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_types.VSCodeUri>(positional, 0, 'uri', 'getWorkspaceFolder');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 30);
...
BridgedClass _createVSCodeChatBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_chat.VSCodeChat,
    name: 'VSCodeChat',
    constructors: {
      '': (visitor, positional, named) {
        D4.requireMinArgs(positional, 1, 'VSCodeChat');
        final adapter = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_adapter.VSCodeAdapter>(positional, 0, '_adapter', 'VSCodeChat');
        return ext_tom_vscode_scripting_api_vscode_chat.VSCodeChat(adapter);
      },
    },
    methods: {
      'createChatParticipant': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.VSCodeChat>(target, 'VSCodeChat');
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 300);
        return t.createChatParticipant(id, handler: (ext_tom_vscode_scripting_api_vscode_chat.ChatRequest p0, ext_tom_vscode_scripting_api_vscode_chat.ChatContext p1, ext_tom_vscode_scripting_api_vscode_chat.ChatResponseStream p2) { return (handlerRaw as InterpretedFunction).call(visitor, [p0, p1, p2]) as Future<ext_tom_vscode_scripting_api_vscode_chat.ChatResult>; }, description: description, fullName: fullName, timeoutSeconds: timeoutSeconds);
      },
    },
    staticMethods: {
      'handleChatRequest': (visitor, positional, named, typeArgs) {
        ...
        final params = D4.coerceMap<String, dynamic>(positional[0], 'params');
        return ext_tom_vscode_scripting_api_vscode_chat.VSCodeChat.handleChatRequest(params);
      },
    },
    constructorSignatures: {
...
BridgedClass _createChatParticipantBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_chat.ChatParticipant,
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final description = D4.getOptionalNamedArg<String?>(named, 'description');
        final fullName = D4.getOptionalNamedArg<String?>(named, 'fullName');
        return ext_tom_vscode_scripting_api_vscode_chat.ChatParticipant(id: id, description: description, fullName: fullName);
      },
      'fromJson': (visitor, positional, named) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_chat.ChatParticipant.fromJson(json);
      },
    },
    getters: {
      'id': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatParticipant>(target, 'ChatParticipant').id,
      'description': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatParticipant>(target, 'ChatParticipant').description,
      'fullName': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatParticipant>(target, 'ChatParticipant').fullName,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatParticipant>(target, 'ChatParticipant');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createChatRequestBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_chat.ChatRequest,
    name: 'ChatRequest',
    constructors: {
      '': (visitor, positional, named) {
        ...
        final references = D4.coerceList<ext_tom_vscode_scripting_api_vscode_chat.ChatPromptReference>(named['references'], 'references');
        return ext_tom_vscode_scripting_api_vscode_chat.ChatRequest(prompt: prompt, command: command, references: references);
      },
      'fromJson': (visitor, positional, named) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_chat.ChatRequest.fromJson(json);
      },
    },
    getters: {
      'prompt': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatRequest>(target, 'ChatRequest').prompt,
      'command': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatRequest>(target, 'ChatRequest').command,
      'references': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatRequest>(target, 'ChatRequest').references,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatRequest>(target, 'ChatRequest');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createChatPromptReferenceBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_chat.ChatPromptReference,
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_chat.ChatPromptReference(id: id, value: value, modelDescription: modelDescription);
      },
      'fromJson': (visitor, positional, named) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_chat.ChatPromptReference.fromJson(json);
      },
    },
    getters: {
      'id': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatPromptReference>(target, 'ChatPromptReference').id,
      'value': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatPromptReference>(target, 'ChatPromptReference').value,
      'modelDescription': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatPromptReference>(target, 'ChatPromptReference').modelDescription,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatPromptReference>(target, 'ChatPromptReference');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createChatContextBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_chat.ChatContext,
    name: 'ChatContext',
    constructors: {
      '': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_chat.ChatContext(history: history);
      },
      'fromJson': (visitor, positional, named) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_chat.ChatContext.fromJson(json);
      },
    },
    getters: {
      'history': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatContext>(target, 'ChatContext').history,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatContext>(target, 'ChatContext');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createChatResultBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_chat.ChatResult,
    name: 'ChatResult',
    constructors: {
      '': (visitor, positional, named) {
        final metadata = D4.coerceMapOrNull<String, dynamic>(named['metadata'], 'metadata');
        final errorDetails = D4.getOptionalNamedArg<ext_tom_vscode_scripting_api_vscode_chat.ChatErrorDetails?>(named, 'errorDetails');
        return ext_tom_vscode_scripting_api_vscode_chat.ChatResult(metadata: metadata, errorDetails: errorDetails);
      },
    },
    getters: {
      'metadata': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatResult>(target, 'ChatResult').metadata,
      'errorDetails': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatResult>(target, 'ChatResult').errorDetails,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatResult>(target, 'ChatResult');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createChatErrorDetailsBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_chat.ChatErrorDetails,
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_chat.ChatErrorDetails(message: message, responseIsFiltered: responseIsFiltered);
      },
    },
    getters: {
      'message': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatErrorDetails>(target, 'ChatErrorDetails').message,
      'responseIsFiltered': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatErrorDetails>(target, 'ChatErrorDetails').responseIsFiltered,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatErrorDetails>(target, 'ChatErrorDetails');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createChatResponseStreamBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_chat.ChatResponseStream,
    name: 'ChatResponseStream',
    constructors: {
      '': (visitor, positional, named) {
        D4.requireMinArgs(positional, 2, 'ChatResponseStream');
        final adapter = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_adapter.VSCodeAdapter>(positional, 0, '_adapter', 'ChatResponseStream');
        final streamId = D4.getRequiredArg<String>(positional, 1, '_streamId', 'ChatResponseStream');
        return ext_tom_vscode_scripting_api_vscode_chat.ChatResponseStream(adapter, streamId);
      },
    },
    methods: {
      'markdown': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_chat.ChatResponseStream>(target, 'ChatResponseStream');
...
BridgedClass _createHelperLoggingBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_helper.HelperLogging,
    name: 'HelperLogging',
    constructors: {
    },
    staticGetters: {
      'debugLogging': (visitor) => ext_tom_vscode_scripting_api_vscode_helper.HelperLogging.debugLogging,
    },
    staticGetterSignatures: {
      'debugLogging': 'bool get debugLogging',
    },
...
BridgedClass _createVsCodeHelperBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper,
    name: 'VsCodeHelper',
    constructors: {
    },
    staticMethods: {
      'getVSCode': (visitor, positional, named, typeArgs) {
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getVSCode();
      },
      'setVSCode': (visitor, positional, named, typeArgs) {
        D4.requireMinArgs(positional, 1, 'setVSCode');
        final vscode = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode.VSCode>(positional, 0, 'vscode', 'setVSCode');
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.setVSCode(vscode);
      },
      'initialize': (visitor, positional, named, typeArgs) {
        D4.requireMinArgs(positional, 1, 'initialize');
        final adapter = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_adapter.VSCodeAdapter>(positional, 0, 'adapter', 'initialize');
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.initialize(adapter);
      },
      'getWindowId': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 30);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getWindowId(timeoutSeconds: timeoutSeconds);
      },
      'generateTimestampId': (visitor, positional, named, typeArgs) {
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.generateTimestampId();
      },
      'showInfo': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 300);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.showInfo(message, choices: choices, timeoutSeconds: timeoutSeconds);
      },
      'showWarning': (visitor, positional, named, typeArgs) {
        ...
        final choices = D4.coerceListOrNull<String>(named['choices'], 'choices');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 300);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.showWarning(message, choices: choices, timeoutSeconds: timeoutSeconds);
      },
      'showError': (visitor, positional, named, typeArgs) {
        ...
        final choices = D4.coerceListOrNull<String>(named['choices'], 'choices');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 300);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.showError(message, choices: choices, timeoutSeconds: timeoutSeconds);
      },
      'quickPick': (visitor, positional, named, typeArgs) {
        ...
        final fallbackValueOnTimeout = D4.getOptionalNamedArg<String?>(named, 'fallbackValueOnTimeout');
        final failOnTimeout = D4.getNamedArgWithDefault<bool>(named, 'failOnTimeout', false);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.quickPick(items, placeholder: placeholder, canPickMany: canPickMany, timeoutSeconds: timeoutSeconds, fallbackValueOnTimeout: fallbackValueOnTimeout, failOnTimeout: failOnTimeout);
      },
      'inputBox': (visitor, positional, named, typeArgs) {
        ...
        final fallbackValueOnTimeout = D4.getOptionalNamedArg<String?>(named, 'fallbackValueOnTimeout');
        final failOnTimeout = D4.getNamedArgWithDefault<bool>(named, 'failOnTimeout', false);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.inputBox(prompt: prompt, placeholder: placeholder, defaultValue: defaultValue, password: password, timeoutSeconds: timeoutSeconds, fallbackValueOnTimeout: fallbackValueOnTimeout, failOnTimeout: failOnTimeout);
      },
      'getWorkspaceRoot': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 30);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getWorkspaceRoot(timeoutSeconds: timeoutSeconds);
      },
      'getWorkspaceFolders': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 30);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getWorkspaceFolders(timeoutSeconds: timeoutSeconds);
      },
      'getActiveTextEditor': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 30);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getActiveTextEditor(timeoutSeconds: timeoutSeconds);
      },
      'findFiles': (visitor, positional, named, typeArgs) {
        ...
        final maxResults = D4.getOptionalNamedArg<int?>(named, 'maxResults');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 60);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.findFiles(include: include, exclude: exclude, maxResults: maxResults, timeoutSeconds: timeoutSeconds);
      },
      'readFile': (visitor, positional, named, typeArgs) {
        D4.requireMinArgs(positional, 1, 'readFile');
        final path = D4.getRequiredArg<String>(positional, 0, 'path', 'readFile');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 60);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.readFile(path, timeoutSeconds: timeoutSeconds);
      },
      'writeFile': (visitor, positional, named, typeArgs) {
        ...
        final content = D4.getRequiredArg<String>(positional, 1, 'content', 'writeFile');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 60);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.writeFile(path, content, timeoutSeconds: timeoutSeconds);
      },
      'createFile': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 60);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.createFile(path, content: content, timeoutSeconds: timeoutSeconds);
      },
      'deleteFile': (visitor, positional, named, typeArgs) {
        D4.requireMinArgs(positional, 1, 'deleteFile');
        final path = D4.getRequiredArg<String>(positional, 0, 'path', 'deleteFile');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 60);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.deleteFile(path, timeoutSeconds: timeoutSeconds);
      },
      'fileExists': (visitor, positional, named, typeArgs) {
        D4.requireMinArgs(positional, 1, 'fileExists');
        final path = D4.getRequiredArg<String>(positional, 0, 'path', 'fileExists');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 30);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.fileExists(path, timeoutSeconds: timeoutSeconds);
      },
      'executeCommand': (visitor, positional, named, typeArgs) {
        ...
        final args = D4.coerceListOrNull<dynamic>(named['args'], 'args');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 120);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.executeCommand(command, args: args, timeoutSeconds: timeoutSeconds);
      },
      'setStatus': (visitor, positional, named, typeArgs) {
        ...
        final timeout = D4.getOptionalNamedArg<int?>(named, 'timeout');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 120);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.setStatus(message, timeout: timeout, timeoutSeconds: timeoutSeconds);
      },
      'createOutput': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 60);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.createOutput(name, initialContent: initialContent, timeoutSeconds: timeoutSeconds);
      },
      'appendOutput': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 60);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.appendOutput(channel, text, timeoutSeconds: timeoutSeconds);
      },
      'copyToClipboard': (visitor, positional, named, typeArgs) {
        D4.requireMinArgs(positional, 1, 'copyToClipboard');
        final text = D4.getRequiredArg<String>(positional, 0, 'text', 'copyToClipboard');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 10);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.copyToClipboard(text, timeoutSeconds: timeoutSeconds);
      },
      'readClipboard': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 10);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.readClipboard(timeoutSeconds: timeoutSeconds);
      },
      'openFile': (visitor, positional, named, typeArgs) {
        ...
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.openFile(path, timeoutSeconds: timeoutSeconds);
      },
      'getConfig': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 60);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getConfig(section, key: key, timeoutSeconds: timeoutSeconds);
      },
      'setConfig': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 60);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.setConfig(section, key, value, global: global, timeoutSeconds: timeoutSeconds);
      },
      'runPubGet': (visitor, positional, named, typeArgs) {
        final workingDirectory = D4.getOptionalNamedArg<String?>(named, 'workingDirectory');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 300);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.runPubGet(workingDirectory: workingDirectory, timeoutSeconds: timeoutSeconds);
      },
      'runPubUpgrade': (visitor, positional, named, typeArgs) {
        final workingDirectory = D4.getOptionalNamedArg<String?>(named, 'workingDirectory');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 300);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.runPubUpgrade(workingDirectory: workingDirectory, timeoutSeconds: timeoutSeconds);
      },
      'addDependency': (visitor, positional, named, typeArgs) {
        ...
        final version = D4.getOptionalNamedArg<String?>(named, 'version');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 180);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.addDependency(name, version: version, timeoutSeconds: timeoutSeconds);
      },
      'getDiagnostics': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 120);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getDiagnostics(uri, timeoutSeconds: timeoutSeconds);
      },
      'formatDocument': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 180);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.formatDocument(uri, timeoutSeconds: timeoutSeconds);
      },
      'organizeImports': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 180);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.organizeImports(uri, timeoutSeconds: timeoutSeconds);
      },
      'hotReload': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 180);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.hotReload(timeoutSeconds: timeoutSeconds);
      },
      'hotRestart': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 240);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.hotRestart(timeoutSeconds: timeoutSeconds);
      },
      'getFlutterDevices': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 180);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getFlutterDevices(timeoutSeconds: timeoutSeconds);
      },
      'runFlutterApp': (visitor, positional, named, typeArgs) {
        ...
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.runFlutterApp(deviceId: deviceId, timeoutSeconds: timeoutSeconds);
      },
      'askCopilot': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 300);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.askCopilot(prompt, context: context, timeoutSeconds: timeoutSeconds);
      },
      'askCopilotChat': (visitor, positional, named, typeArgs) {
        ...
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.askCopilotChat(prompt, requestId: requestId, pollIntervalSeconds: pollIntervalSeconds, timeoutSeconds: timeoutSeconds, customResponseInstructions: customResponseInstructions);
      },
      'askModel': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 300);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.askModel(modelId, prompt, context: context, vendor: vendor, timeoutSeconds: timeoutSeconds);
      },
      'getCopilotSuggestion': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 300);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getCopilotSuggestion(code, instruction, timeoutSeconds: timeoutSeconds);
      },
      'explainCode': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 300);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.explainCode(code, timeoutSeconds: timeoutSeconds);
      },
      'reviewCode': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 300);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.reviewCode(code, timeoutSeconds: timeoutSeconds);
      },
      'generateTests': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 300);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.generateTests(code, timeoutSeconds: timeoutSeconds);
      },
      'fixCode': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 300);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.fixCode(code, error, timeoutSeconds: timeoutSeconds);
      },
      'selectCopilotModel': (visitor, positional, named, typeArgs) {
        ...
        final id = D4.getOptionalNamedArg<String?>(named, 'id');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 120);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.selectCopilotModel(family: family, vendor: vendor, id: id, timeoutSeconds: timeoutSeconds);
      },
      'getCopilotModels': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 120);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getCopilotModels(timeoutSeconds: timeoutSeconds);
      },
      'replaceText': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 180);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.replaceText(uri, startLine, startChar, endLine, endChar, text, timeoutSeconds: timeoutSeconds);
      },
      'insertSnippet': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 180);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.insertSnippet(uri, line, character, snippet, timeoutSeconds: timeoutSeconds);
      },
      'applyWorkspaceEdit': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 180);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.applyWorkspaceEdit(edits, timeoutSeconds: timeoutSeconds);
      },
      'getSelection': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 60);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getSelection(timeoutSeconds: timeoutSeconds);
      },
      'setSelection': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 120);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.setSelection(startLine, startChar, endLine, endChar, timeoutSeconds: timeoutSeconds);
      },
      'getCursorPosition': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 60);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getCursorPosition(timeoutSeconds: timeoutSeconds);
      },
      'getProjectFiles': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 120);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getProjectFiles(pattern, excludeTests: excludeTests, timeoutSeconds: timeoutSeconds);
      },
      'getGitRoot': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 120);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getGitRoot(timeoutSeconds: timeoutSeconds);
      },
      'getProjectType': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 120);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getProjectType(timeoutSeconds: timeoutSeconds);
      },
      'searchInWorkspace': (visitor, positional, named, typeArgs) {
        ...
        final maxResults = D4.getOptionalNamedArg<int?>(named, 'maxResults');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 180);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.searchInWorkspace(query, includePattern: includePattern, excludePattern: excludePattern, isRegex: isRegex, maxResults: maxResults, timeoutSeconds: timeoutSeconds);
      },
      'replaceInWorkspace': (visitor, positional, named, typeArgs) {
        ...
        final isRegex = D4.getNamedArgWithDefault<bool>(named, 'isRegex', false);
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 180);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.replaceInWorkspace(query, replacement, includePattern: includePattern, excludePattern: excludePattern, isRegex: isRegex, timeoutSeconds: timeoutSeconds);
      },
      'runTests': (visitor, positional, named, typeArgs) {
        final uri = D4.getOptionalNamedArg<String?>(named, 'uri');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 420);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.runTests(uri: uri, timeoutSeconds: timeoutSeconds);
      },
      'runTestsWithCoverage': (visitor, positional, named, typeArgs) {
        final uri = D4.getOptionalNamedArg<String?>(named, 'uri');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 600);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.runTestsWithCoverage(uri: uri, timeoutSeconds: timeoutSeconds);
      },
      'getTestResults': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 240);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getTestResults(timeoutSeconds: timeoutSeconds);
      },
      'startDebugging': (visitor, positional, named, typeArgs) {
        final config = D4.coerceMapOrNull<String, dynamic>(named['config'], 'config');
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 300);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.startDebugging(config: config, timeoutSeconds: timeoutSeconds);
      },
      'stopDebugging': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 180);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.stopDebugging(timeoutSeconds: timeoutSeconds);
      },
      'setBreakpoint': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 180);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.setBreakpoint(uri, line, timeoutSeconds: timeoutSeconds);
      },
      'removeBreakpoint': (visitor, positional, named, typeArgs) {
        ...
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 180);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.removeBreakpoint(uri, line, timeoutSeconds: timeoutSeconds);
      },
      'getBreakpoints': (visitor, positional, named, typeArgs) {
        final timeoutSeconds = D4.getNamedArgWithDefault<int>(named, 'timeoutSeconds', 180);
        return ext_tom_vscode_scripting_api_vscode_helper.VsCodeHelper.getBreakpoints(timeoutSeconds: timeoutSeconds);
      },
    },
    staticMethodSignatures: {
...
BridgedClass _createVsProgressBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_helper.VsProgress,
    name: 'VsProgress',
    constructors: {
    },
    getters: {
      'channelName': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_helper.VsProgress>(target, 'VsProgress').channelName,
    },
    methods: {
      'report': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_helper.VsProgress>(target, 'VsProgress');
    ...
    staticMethods: {
      'create': (visitor, positional, named, typeArgs) {
        ...
        return ext_tom_vscode_scripting_api_vscode_helper.VsProgress.create(name);
      },
    },
    methodSignatures: {
...
BridgedClass _createFileBatchBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_helper.FileBatch,
    name: 'FileBatch',
    constructors: {
    },
    getters: {
      'files': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_helper.FileBatch>(target, 'FileBatch').files,
      'count': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_helper.FileBatch>(target, 'FileBatch').count,
    },
    methods: {
      'process': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_helper.FileBatch>(target, 'FileBatch');
    ...
    staticMethods: {
      'fromPattern': (visitor, positional, named, typeArgs) {
        ...
        final exclude = D4.getOptionalNamedArg<String?>(named, 'exclude');
        final maxResults = D4.getOptionalNamedArg<int?>(named, 'maxResults');
        return ext_tom_vscode_scripting_api_vscode_helper.FileBatch.fromPattern(include: include, exclude: exclude, maxResults: maxResults);
      },
    },
    methodSignatures: {
...
BridgedClass _createVSCodeUriBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_types.VSCodeUri,
    name: 'VSCodeUri',
    constructors: {
      '': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_types.VSCodeUri(scheme: scheme, authority: authority, path: path, query: query, fragment: fragment, fsPath: fsPath);
      },
      'file': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_types.VSCodeUri.file(path);
      },
      'fromJson': (visitor, positional, named) {
        D4.requireMinArgs(positional, 1, 'VSCodeUri');
        if (positional.isEmpty) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_types.VSCodeUri.fromJson(json);
      },
    },
    getters: {
      'scheme': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.VSCodeUri>(target, 'VSCodeUri').scheme,
      'authority': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.VSCodeUri>(target, 'VSCodeUri').authority,
      'path': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.VSCodeUri>(target, 'VSCodeUri').path,
      'query': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.VSCodeUri>(target, 'VSCodeUri').query,
      'fragment': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.VSCodeUri>(target, 'VSCodeUri').fragment,
      'fsPath': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.VSCodeUri>(target, 'VSCodeUri').fsPath,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.VSCodeUri>(target, 'VSCodeUri');
        return t.toJson();
      },
...
BridgedClass _createWorkspaceFolderBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_types.WorkspaceFolder,
    name: 'WorkspaceFolder',
    constructors: {
      '': (visitor, positional, named) {
        final uri = D4.getRequiredNamedArg<ext_tom_vscode_scripting_api_vscode_types.VSCodeUri>(named, 'uri', 'WorkspaceFolder');
        ...
        return ext_tom_vscode_scripting_api_vscode_types.WorkspaceFolder(uri: uri, name: name, index: index);
      },
      'fromJson': (visitor, positional, named) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_types.WorkspaceFolder.fromJson(json);
      },
    },
    getters: {
      'uri': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.WorkspaceFolder>(target, 'WorkspaceFolder').uri,
      'name': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.WorkspaceFolder>(target, 'WorkspaceFolder').name,
      'index': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.WorkspaceFolder>(target, 'WorkspaceFolder').index,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.WorkspaceFolder>(target, 'WorkspaceFolder');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createTextDocumentBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_types.TextDocument,
    name: 'TextDocument',
    constructors: {
      '': (visitor, positional, named) {
        final uri = D4.getRequiredNamedArg<ext_tom_vscode_scripting_api_vscode_types.VSCodeUri>(named, 'uri', 'TextDocument');
        ...
        return ext_tom_vscode_scripting_api_vscode_types.TextDocument(uri: uri, fileName: fileName, isUntitled: isUntitled, languageId: languageId, version: version, isDirty: isDirty, isClosed: isClosed, lineCount: lineCount);
      },
      'fromJson': (visitor, positional, named) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_types.TextDocument.fromJson(json);
      },
    },
    getters: {
      'uri': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TextDocument>(target, 'TextDocument').uri,
      'fileName': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TextDocument>(target, 'TextDocument').fileName,
      'isUntitled': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TextDocument>(target, 'TextDocument').isUntitled,
      'languageId': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TextDocument>(target, 'TextDocument').languageId,
      'version': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TextDocument>(target, 'TextDocument').version,
      'isDirty': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TextDocument>(target, 'TextDocument').isDirty,
      'isClosed': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TextDocument>(target, 'TextDocument').isClosed,
      'lineCount': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TextDocument>(target, 'TextDocument').lineCount,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TextDocument>(target, 'TextDocument');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createPositionBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_types.Position,
    name: 'Position',
    constructors: {
      '': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_types.Position(line, character);
      },
      'fromJson': (visitor, positional, named) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_types.Position.fromJson(json);
      },
    },
    getters: {
      'line': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.Position>(target, 'Position').line,
      'character': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.Position>(target, 'Position').character,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.Position>(target, 'Position');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createRangeBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_types.Range,
    name: 'Range',
    constructors: {
      '': (visitor, positional, named) {
        D4.requireMinArgs(positional, 2, 'Range');
        final start = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_types.Position>(positional, 0, 'start', 'Range');
        final end = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_types.Position>(positional, 1, 'end', 'Range');
        return ext_tom_vscode_scripting_api_vscode_types.Range(start, end);
      },
      'fromJson': (visitor, positional, named) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_types.Range.fromJson(json);
      },
    },
    getters: {
      'start': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.Range>(target, 'Range').start,
      'end': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.Range>(target, 'Range').end,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.Range>(target, 'Range');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createSelectionBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_types.Selection,
    name: 'Selection',
    constructors: {
      '': (visitor, positional, named) {
        D4.requireMinArgs(positional, 3, 'Selection');
        final anchor = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_types.Position>(positional, 0, 'anchor', 'Selection');
        final active = D4.getRequiredArg<ext_tom_vscode_scripting_api_vscode_types.Position>(positional, 1, 'active', 'Selection');
        final isReversed = D4.getRequiredArg<bool>(positional, 2, 'isReversed', 'Selection');
        return ext_tom_vscode_scripting_api_vscode_types.Selection(anchor, active, isReversed);
      },
      'fromJson': (visitor, positional, named) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_types.Selection.fromJson(json);
      },
    },
    getters: {
      'start': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.Selection>(target, 'Selection').start,
      'end': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.Selection>(target, 'Selection').end,
      'anchor': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.Selection>(target, 'Selection').anchor,
      'active': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.Selection>(target, 'Selection').active,
      'isReversed': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.Selection>(target, 'Selection').isReversed,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.Selection>(target, 'Selection');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createTextEditorBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_types.TextEditor,
    name: 'TextEditor',
    constructors: {
      '': (visitor, positional, named) {
        final document = D4.getRequiredNamedArg<ext_tom_vscode_scripting_api_vscode_types.TextDocument>(named, 'document', 'TextEditor');
        final selection = D4.getRequiredNamedArg<ext_tom_vscode_scripting_api_vscode_types.Selection>(named, 'selection', 'TextEditor');
        ...
        final selections = D4.coerceList<ext_tom_vscode_scripting_api_vscode_types.Selection>(named['selections'], 'selections');
        final visibleRanges = D4.getOptionalNamedArg<ext_tom_vscode_scripting_api_vscode_types.Range?>(named, 'visibleRanges');
        return ext_tom_vscode_scripting_api_vscode_types.TextEditor(document: document, selection: selection, selections: selections, visibleRanges: visibleRanges);
      },
      'fromJson': (visitor, positional, named) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_types.TextEditor.fromJson(json);
      },
    },
    getters: {
      'document': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TextEditor>(target, 'TextEditor').document,
      'selection': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TextEditor>(target, 'TextEditor').selection,
      'selections': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TextEditor>(target, 'TextEditor').selections,
      'visibleRanges': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TextEditor>(target, 'TextEditor').visibleRanges,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TextEditor>(target, 'TextEditor');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createQuickPickItemBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_types.QuickPickItem,
    name: 'QuickPickItem',
    constructors: {
      '': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_types.QuickPickItem(label: label, description: description, detail: detail, picked: picked);
      },
      'fromJson': (visitor, positional, named) {
        ...
        final json = D4.coerceMap<String, dynamic>(positional[0], 'json');
        return ext_tom_vscode_scripting_api_vscode_types.QuickPickItem.fromJson(json);
      },
    },
    getters: {
      'label': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.QuickPickItem>(target, 'QuickPickItem').label,
      'description': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.QuickPickItem>(target, 'QuickPickItem').description,
      'detail': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.QuickPickItem>(target, 'QuickPickItem').detail,
      'picked': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.QuickPickItem>(target, 'QuickPickItem').picked,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.QuickPickItem>(target, 'QuickPickItem');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createInputBoxOptionsBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_types.InputBoxOptions,
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        final value = D4.getOptionalNamedArg<String?>(named, 'value');
        final password = D4.getNamedArgWithDefault<bool>(named, 'password', false);
        return ext_tom_vscode_scripting_api_vscode_types.InputBoxOptions(prompt: prompt, placeHolder: placeHolder, value: value, password: password);
      },
    },
    getters: {
      'prompt': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.InputBoxOptions>(target, 'InputBoxOptions').prompt,
      'placeHolder': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.InputBoxOptions>(target, 'InputBoxOptions').placeHolder,
      'value': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.InputBoxOptions>(target, 'InputBoxOptions').value,
      'password': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.InputBoxOptions>(target, 'InputBoxOptions').password,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.InputBoxOptions>(target, 'InputBoxOptions');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createMessageOptionsBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_types.MessageOptions,
    name: 'MessageOptions',
    constructors: {
      '': (visitor, positional, named) {
        final modal = D4.getNamedArgWithDefault<bool>(named, 'modal', false);
        final detail = D4.getOptionalNamedArg<String?>(named, 'detail');
        return ext_tom_vscode_scripting_api_vscode_types.MessageOptions(modal: modal, detail: detail);
      },
    },
    getters: {
      'modal': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.MessageOptions>(target, 'MessageOptions').modal,
      'detail': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.MessageOptions>(target, 'MessageOptions').detail,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.MessageOptions>(target, 'MessageOptions');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createTerminalOptionsBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_types.TerminalOptions,
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_types.TerminalOptions(name: name, shellPath: shellPath, shellArgs: shellArgs, cwd: cwd, env: env);
      },
    },
    getters: {
      'name': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TerminalOptions>(target, 'TerminalOptions').name,
      'shellPath': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TerminalOptions>(target, 'TerminalOptions').shellPath,
      'shellArgs': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TerminalOptions>(target, 'TerminalOptions').shellArgs,
      'cwd': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TerminalOptions>(target, 'TerminalOptions').cwd,
      'env': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TerminalOptions>(target, 'TerminalOptions').env,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.TerminalOptions>(target, 'TerminalOptions');
        return t.toJson();
      },
    },
    constructorSignatures: {
...
BridgedClass _createFileSystemWatcherOptionsBridge() {
  return BridgedClass(
    nativeType: ext_tom_vscode_scripting_api_vscode_types.FileSystemWatcherOptions,
    ...
    constructors: {
      '': (visitor, positional, named) {
        ...
        return ext_tom_vscode_scripting_api_vscode_types.FileSystemWatcherOptions(ignoreCreateEvents: ignoreCreateEvents, ignoreChangeEvents: ignoreChangeEvents, ignoreDeleteEvents: ignoreDeleteEvents);
      },
    },
    getters: {
      'ignoreCreateEvents': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.FileSystemWatcherOptions>(target, 'FileSystemWatcherOptions').ignoreCreateEvents,
      'ignoreChangeEvents': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.FileSystemWatcherOptions>(target, 'FileSystemWatcherOptions').ignoreChangeEvents,
      'ignoreDeleteEvents': (visitor, target) => D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.FileSystemWatcherOptions>(target, 'FileSystemWatcherOptions').ignoreDeleteEvents,
    },
    methods: {
      'toJson': (visitor, target, positional, named, typeArgs) {
        final t = D4.validateTarget<ext_tom_vscode_scripting_api_vscode_types.FileSystemWatcherOptions>(target, 'FileSystemWatcherOptions');
        return t.toJson();
      },
    },
    constructorSignatures: {
